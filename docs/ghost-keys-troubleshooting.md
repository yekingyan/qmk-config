...
## 附注：待确认引脚对照（仅为工作假设，未经硬证据确认）

以下映射来自 RP2040 Pro Micro 兼容主控的常见布局推断，**不是最终 pinout**，后续拿到卖家 pinout/原理图后应以硬证据回填。

| Pro Micro 别名 | RP2040 GPIO | 确认状态 |
|---|---:|---|
| F7 | GP26 | ✅ 已确认（ADC0，当前异常） |
| F6 | GP27 | ✅ 已确认（ADC1，当前异常） |
| F5 | GP28 | ✅ 已确认（ADC2，当前异常） |
| F4 | GP29 | ✅ 已确认（ADC3，当前异常） |
| B1 | GP20 | ⚠️ 工作假设，尚未硬证实 |
| B3 | GP21 | ⚠️ 工作假设，尚未硬证实 |
| B2 | GP22 | ⚠️ 工作假设，尚未硬证实 |
| B6 | GP23 | ⚠️ 工作假设，尚未硬证实 |
